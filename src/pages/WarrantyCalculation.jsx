          ...
          <>
            <div className=" w-full xl:w-[50%] mx-auto">
              <div>
                ...
                <p className="mt-[30px] text-brand-regular  text-md">
              ...
              <div className="flex flex-col w-24 mt-[40px]">
                <label className="text-brand-regular  text-sm mb-1">Euro</label>
